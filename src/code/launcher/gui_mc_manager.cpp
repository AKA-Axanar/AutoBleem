...
void GuiMcManager::loadAssets() {
    ...
    mcGrid = IMG_LoadTexture(renderer, (gui->getCurrentThemeImageFile("MC/Dot_Matrix.png").c_str()));
    mcPencil = IMG_LoadTexture(renderer, (gui->getCurrentThemeImageFile("MC/Pencil_Carsor.png").c_str()));
