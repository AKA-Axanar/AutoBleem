...
void GuiLauncher::render() {
    ...
    Gui::renderTextOnly_WithColor(638, 640, _("Enter"), {secR, secG, secB, 0}, font24, XALIGN_LEFT, false);
    Gui::renderTextOnly_WithColor(800, 640, _("Cancel"), {secR, secG, secB, 0}, font24, XALIGN_LEFT, false);
    Gui::renderTextOnly_WithColor(945, 640, _("Button Guide"), {secR, secG, secB, 0}, font24, XALIGN_LEFT, false);
