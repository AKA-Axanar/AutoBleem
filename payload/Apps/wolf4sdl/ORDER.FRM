...
Phone (optional) ________________________  Circle:  home  or  work

Important:  Is this your first order with Apogee Software?   yes   no

Circle disk size:   5 1/4"    3 1/2"    Circle Graphics:  CGA   EGA   VGA

 [] Wolfenstein 3-D  (VGA only, 80286+ required)  (episodes 1 - 3 for $35)
 [] Wolf3-D Nocturnal Missions Trilogy    (requires first 3 episodes, $20)
 [] Wolfenstein 3-D All SIX EPISODES "Wolf-Pak"--Save $5   (1 - 6 for $50)
 ...
 [] Word Rescue (Apogee's first educational game)          (all 3 for $30)
 [] Cosmo  (requires 80286+ system or better to run)       (all 3 for $35)
...
Make checks payable to "Apogee".  Orders shipped within one week.
